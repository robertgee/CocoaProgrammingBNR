                                 ...
                                 withDefaultAttributes:(NSDictionary *)attributes
{
    ...
    NSMutableDictionary *attrDict = [attributes mutableCopy];
    [attrDict setObject:anObj
                 forKey:NSForegroundColorAttributeName];
    
    NSAttributedString *attrString = [[NSAttributedString alloc] initWithString:match attributes:attrDict];
